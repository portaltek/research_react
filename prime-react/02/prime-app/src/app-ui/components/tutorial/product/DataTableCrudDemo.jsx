        ...
        <div className="demo-data-table">
                ...
                <div className="formgrid grid">
                    ...
                    <div className="field col">
                        ...
                        <InputNumber id="quantity"
                            ...
                            onValueChange={
                                (e) => onInputNumberChange(e, 'quantity')
                            }
                            integeronly/>
                    </div>
                </div>
            ...
            <Dialog visible={deleteProductDialog}
                ...
                <div className="confirmation-content">
                    ...
                    product && <span>Are you sure you want to delete
                        <b>{
                            product.name
                        }</b>?</span>
                } </div>
            ...
            <Dialog visible={deleteProductsDialog}
                style={
                    {width: '450px'}
                }
                header="Confirm"
